        ...
        <div class="modal-content border-0 rounded-0 text-center">
            ...
            <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                <div class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                    <?php if (!empty($get_rds_template_data_array["globals"]["promotion"]["popup_form_heading"])) { ?>
                        <h3 class="px-lg-0 px-4"><?php echo esc_html($get_rds_template_data_array["globals"]["promotion"]["popup_form_heading"]); ?></h3>
                    <?php } ?>
                    <div class="my-md-0 mt-lg-4 mt-3 w-lg-260 mx-auto text-start text-lg-center d-flex align-items-center justify-content-center pb-4 px-lg-0 px-4">
                        ...
                        <span class="font_alt_1 text_bold text_16 line_height_25 sm_text_16  sm_line_height_30 color_primary"><?php echo esc_html($get_rds_template_data_array["globals"]["promotion"]["popup_form_subheading"]); ?></span>
                    </div>
